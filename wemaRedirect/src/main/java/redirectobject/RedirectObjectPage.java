...
public class RedirectObjectPage {
    ...
    public void scrollDownToElementLink(){
        wait.until(ExpectedConditions.
                presenceOfElementLocated(
                        By.cssSelector(Selectors.elementalSeleniumLink)));
        WebElement redirectLink = driver.findElement(By.cssSelector(Selectors.elementalSeleniumLink));
    ...
    public void joinMailingList(){
        wait.until(ExpectedConditions.
                presenceOfElementLocated(
                        By.cssSelector(Selectors.mailing)));
        driver.findElement(By.cssSelector(Selectors.mailing)).click();
    }

    public void selectJava(){
        Select select = new Select(driver.findElement(By.cssSelector(Selectors.select)));
        select.selectByValue(Selectors.java1);
    }
